...
def fileForm(request):
    if request.method == 'POST':
        ...
        form = KokFileForm()
    return render(request, 'kok/fileForm.html', {
        'form': form
    })
...
def subjectForm(request):
    if request.method == 'POST':
        ...
        form = KokSubjectForm()
        return render(request, 'kok/subjectForm.html', {'form': form})


@login_required
def firstPage(request):
    subjects = Subject.objects.all()
    return render(request, "kok/firstPage.html", {"subjects": subjects})
...
def filePage(request, pk):
    ...
    return render(request, "kok/filePage.html", {"subject": subject, "files": files})
